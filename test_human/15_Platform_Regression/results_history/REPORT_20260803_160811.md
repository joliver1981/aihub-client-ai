# Platform Regression Report — 20260803_160811 (local dev)

- Build: `95228f7` | Base: `http://localhost:5001` | Baseline: `results_20260802_204024.json`
...
| Agents | agent_crud | ✅ PASS | id=889, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=890, ingest=success, chars=2449, type=policy_document, deleted=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=434, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Agents | comp_agent_admits_unknown | ✅ PASS | admits-it-does-not-know=True; reply='## 📄 Request Clarification\n\nI don’t have access to any internal project registry or database that would identify the code `REGP-20' |
| Knowledge/Docs | comp_knowledge_retrievable_after_ingest | ✅ PASS | agent=893, kid=1714, marker=ZEPHYR160811, retrieved-the-ingested-fact=True |
| Knowledge/Docs | comp_knowledge_deleted_not_retrievable | 🟡 XPASS | deleted kid=1714; deleted content STILL retrievable=False (must be False) |
...
| Data/NLQ | comp_nlq_admits_unanswerable | ✅ PASS | fabricated-London-foot-traffic=False; reply='I could not find any store location or foot traffic records for a London store in the available data. I checked both store names a' |
