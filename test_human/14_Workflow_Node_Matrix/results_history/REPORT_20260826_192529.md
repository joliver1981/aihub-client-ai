# Workflow Node Regression Report — 20260826_192529

- Build: `012fc96` | Base: `http://localhost:5001` | Tier <= 2 | Baseline: `results_20260819_184635.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260826_192529`

## Verdict: **CLEAN** — 16 PASS / 21 SKIP / 1 XFAIL
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=3FB0790F-3CFE-49F7-B845-D91D462273FF, http=200); post-approval file=True |
...
| file_transfer_sftp_upload | 2 | ✅ PASS | status=completed; remote-file=True (xfer_20260826_192529.txt); content-ok=True |
