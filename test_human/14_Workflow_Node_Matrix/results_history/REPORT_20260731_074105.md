# Workflow Node Regression Report — 20260731_074105

- Build: `5a3e564` | Base: `http://localhost:5001` | Tier <= 2 | Baseline: `results_20260730_213531.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260731_074105`

## Verdict: **CLEAN** — 15 PASS / 11 SKIP / 2 XFAIL
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=6BCD8D53-219E-443A-A014-FC60C9C9B8D8, http=200); post-approval file=True |
...
| file_transfer_sftp_upload | 2 | ✅ PASS | status=completed; remote-file=True (xfer_20260731_074105.txt); content-ok=True |
