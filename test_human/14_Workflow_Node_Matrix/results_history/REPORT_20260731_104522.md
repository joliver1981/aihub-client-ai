# Workflow Node Regression Report — 20260731_104522

- Build: `7524ebb` | Base: `http://10.0.0.6:5001` | Tier <= 2 | Baseline: `results_20260731_104305.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260731_104522`

## Verdict: **FAILURES (no baseline regression)** — 1 FAIL / 27 SKIP
...
| file_transfer_sftp_upload | 2 | ❌ FAIL | status=failed; remote-file=False (xfer_20260731_104522.txt); content-ok=False \| log-tail: Executing node: file write (File) ~ Workflow execution started: NODEREG-file_transfer_sftp_upload |
