# AuthZ Matrix - 20260902_204546

- Tier: A | Baseline: `results_20260826_213446.json`
...
|---|---|---|
| a1_global_auth_middleware_wired | XFAIL | middleware-module-present=True, init_auth_middleware called by=['app.py'], anon GET /api/scheduler/jobs -> 200 46378b (reachable=True) |
...
| a7_session_cookie_flags | PASS | HttpOnly=True, SameSite=False, hdr='session=.eJwlzjtuAzEMRdG9qE5Bihp-vBmDIikkCJAAM3YVZO9WkPK94uL8tPs663pvt8f5rLd2_8h2a51MMkE9U' |
...
| a11_anonymous_get_sweep_ratchet | PASS | probed=236, ANONYMOUSLY REACHABLE=27 vs pinned 29 (ratchet: must not grow - PASS is NOT 'no problem'), errors=49, cleaned-up-minted-rows=0; first: /, /admin/caution-settings, /api/available-icons, /api/caution/level, /api/caution/ |
...
| `/api/workflow/analytics` | 200 25707b |
| `/api/workflow/approvals` | 200 371062b |
| `/api/workflow/assistant/history` | 200 142b |
| `/api/workflow/builder/training-stats` | 200 129b |
| `/api/workflow/stats/counts` | 200 165b |
| `/api_check` | 200 555b |
| `/chat/data` | 200 199b |
