# Workflow Node Regression Report — 20260802_152111

- Build: `0dcdc24` | Base: `http://localhost:5001` | Tier <= 2 | Baseline: `results_20260802_151657.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260802_152111`

## Verdict: **CLEAN** — 16 PASS / 11 SKIP / 1 XFAIL
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=2A808A1B-4F6B-45C2-A5B6-8BE321974A0D, http=200); post-approval file=True |
...
| file_transfer_sftp_upload | 2 | ✅ PASS | status=completed; remote-file=True (xfer_20260802_152111.txt); content-ok=True |
...
| File | setvar_file_write:PASS; file_write_append:PASS; file_check_delete:PASS; conditional_true:PASS; conditional_false:PASS; loop_list_append:PASS; setvar_expression_eval:PASS; setvar_expression_failure_honesty:XFAIL; database_fail_edge:PASS; human_approval_approve:PASS; human_approval_reject:PASS; file_transfer_sftp_upload:PASS |
...
## Config lint (informational) — scanned ALL 249 persisted workflows
