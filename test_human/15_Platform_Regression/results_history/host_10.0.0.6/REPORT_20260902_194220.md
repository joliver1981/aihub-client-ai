# Platform Regression Report — 20260902_194220 (INSTALLED 10.0.0.6)

- Build: `a32095f` | Base: `http://10.0.0.6:5001` | Baseline: `results_20260902_091058.json`

## Verdict: **FAILURES (no baseline regression)** — 1 FAIL / 49 PASS / 51 SKIP / 2 XFAIL / 3 XPASS

## 🟢 Fixed vs baseline

- wf14:baseline: FAIL → PASS
...
| Agents | agent_crud | ✅ PASS | id=7014, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=7015, ingest=success, chars=2450, type=policy_document, deleted=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=1051, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Agents | comp_agent_admits_unknown | ✅ PASS | admits-it-does-not-know=True; reply='I couldn’t retrieve the details for internal project code **REGP-20260902_194220-XQ7** because the system reported an **“Invalid o' |
| Knowledge/Docs | comp_knowledge_retrievable_after_ingest | ✅ PASS | agent=7018, kid=8015, marker=ZEPHYR194220, retrieved-the-ingested-fact=True |
| Knowledge/Docs | comp_knowledge_deleted_not_retrievable | 🟡 XPASS | deleted kid=8015; deleted content STILL retrievable=False (must be False) |
...
| Data/NLQ | comp_nlq_admits_unanswerable | ⏭ SKIP | SKIP: NLQ oracle agent 281 not present on this target |
...
| Data Explorer | de_pin_live | ⏭ SKIP | SKIP: NLQ oracle agent 281 not present on this target |
