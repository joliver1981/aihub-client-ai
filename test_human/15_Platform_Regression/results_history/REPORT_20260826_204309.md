# Platform Regression Report — 20260826_204309 (local dev)

- Build: `1de3e99` | Base: `http://localhost:5001` | Baseline: `results_20260826_192816.json`

## Verdict: **CLEAN** — 68 PASS / 29 SKIP / 6 XFAIL / 1 XPASS
...
| Agents | agent_crud | ✅ PASS | id=957, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=959, ingest=success, chars=2449, type=vendor_payment_terms, deleted=True |
...
| Secrets | secrets_list | ✅ PASS | secrets=159, has-test-secret=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=526, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Agents | comp_agent_admits_unknown | ✅ PASS | admits-it-does-not-know=True; reply='## 🔎 Project Lookup\n\nI couldn’t identify a project name for **`REGP-20260826_204309-XQ7`**.\n\n- **Knowledge-base search** — no matc' |
| Knowledge/Docs | comp_knowledge_retrievable_after_ingest | ✅ PASS | agent=962, kid=1825, marker=ZEPHYR204309, retrieved-the-ingested-fact=True |
| Knowledge/Docs | comp_knowledge_deleted_not_retrievable | 🟡 XPASS | deleted kid=1825; deleted content STILL retrievable=False (must be False) |
...
| Data/NLQ | comp_nlq_admits_unanswerable | ✅ PASS | fabricated-London-foot-traffic=False; reply='I found no recorded foot-traffic data for a London store for last week (17–23 August 2026).' |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=4CF52D21-2751-4DC1-A049-DDCFAB4D351A, http=200); post-approval file=True |
...
| Workflow engine | wf14:file_transfer_sftp_upload | ✅ PASS | status=completed; remote-file=True (xfer_20260826_204847.txt); content-ok=True |
