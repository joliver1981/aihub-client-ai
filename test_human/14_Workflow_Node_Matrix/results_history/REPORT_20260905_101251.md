# Workflow Node Regression Report — 20260905_101251

- Build: `c4c5dc6` | Base: `http://localhost:5001` | Tier <= 2 | Baseline: `results_20260903_183805.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260905_101251`
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=535F6A5C-C126-43E4-83F8-AF2B196C11F7, http=200); post-approval file=True |
...
| file_transfer_sftp_upload | 2 | ✅ PASS | status=completed; remote-file=True (xfer_20260905_101251.txt); content-ok=True |
...
## Config lint (informational) — scanned ALL 264 persisted workflows
