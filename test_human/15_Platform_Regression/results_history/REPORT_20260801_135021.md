# Platform Regression Report — 20260801_135021 (local dev)

- Build: `32191fc` | Base: `http://localhost:5001` | Baseline: `results_20260731_214017.json`

## Verdict: **CLEAN** — 58 PASS / 19 SKIP / 5 XFAIL
...
| Agents | agent_crud | ✅ PASS | id=843, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=844, ingest=success, chars=2449, type=policy_document, deleted=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=283, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=8BF57054-5241-4582-B445-BA4AB7F2F0C5, http=200); post-approval file=True |
...
| Workflow engine | wf14:file_transfer_sftp_upload | ✅ PASS | status=completed; remote-file=True (xfer_20260801_135218.txt); content-ok=True |
