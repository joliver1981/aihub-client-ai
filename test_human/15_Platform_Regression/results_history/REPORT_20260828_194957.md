# Platform Regression Report — 20260828_194957 (local dev)

- Build: `a874bed` | Base: `http://localhost:5001` | Baseline: `results_20260826_204309.json`
...
| Agents | agent_crud | ✅ PASS | id=988, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=990, ingest=success, chars=2449, type=vendor_guide, deleted=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=547, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=F5B12C17-F855-49D7-BDF4-DEB797243D2F, http=200); post-approval file=True |
