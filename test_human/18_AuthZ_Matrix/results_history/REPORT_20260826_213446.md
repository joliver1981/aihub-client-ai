# AuthZ Matrix - 20260826_213446

- Tier: A | Baseline: `results_20260826_194339.json`
...
|---|---|---|
| a1_global_auth_middleware_wired | XFAIL | middleware-module-present=True, init_auth_middleware called by=['app.py'], anon GET /api/scheduler/jobs -> 200 49211b (reachable=True) |
...
| a7_session_cookie_flags | PASS | HttpOnly=True, SameSite=False, hdr='session=.eJwljzFuQzEMQ-_iOYNk2ZKVy3xIlowWAVrg_2QKcvca6EZyIB_f5VhnXl_l_jxfeSvHd5R7qaQSAcMiR' |
...
| a11_anonymous_get_sweep_ratchet | PASS | probed=236, ANONYMOUSLY REACHABLE=29 vs pinned 29 (ratchet: must not grow - PASS is NOT 'no problem'), errors=0, cleaned-up-minted-rows=0; first: /, /admin/caution-settings, /api/available-icons, /api/caution/level, /api/caution/l |
