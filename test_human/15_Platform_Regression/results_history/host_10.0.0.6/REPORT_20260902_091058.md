# Platform Regression Report — 20260902_091058 (INSTALLED 10.0.0.6)

- Build: `4fb6da8` | Base: `http://10.0.0.6:5001` | Baseline: `results_20260806_202017.json`

## Verdict: **FAILURES (no baseline regression)** — 2 FAIL / 48 PASS / 49 SKIP / 2 XFAIL / 3 XPASS
...
| Agents | agent_crud | ✅ PASS | id=7008, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=7009, ingest=success, chars=2450, type=policy_document, deleted=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=1031, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Agents | comp_agent_admits_unknown | ✅ PASS | admits-it-does-not-know=True; reply='I’m unable to look up the internal project code **REGP-20260902_091058-XQ7** because the system encountered an **“Invalid or missi' |
| Knowledge/Docs | comp_knowledge_retrievable_after_ingest | ✅ PASS | agent=7012, kid=8012, marker=ZEPHYR091058, retrieved-the-ingested-fact=True |
| Knowledge/Docs | comp_knowledge_deleted_not_retrievable | 🟡 XPASS | deleted kid=8012; deleted content STILL retrievable=False (must be False) |
...
| Workflow engine | wf14:file_transfer_sftp_upload | ❌ FAIL | status=failed; remote-file=False (xfer_20260902_091206.txt); content-ok=False \| log-tail: Executing node: file write (File) ~ Workflow execution started: NODEREG-file_transfer_sftp_upload |
