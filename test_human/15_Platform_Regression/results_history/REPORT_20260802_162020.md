# Platform Regression Report — 20260802_162020 (local dev)

- Build: `8a18e25` | Base: `http://localhost:5001` | Baseline: `results_20260802_155153.json`
...
| Agents | agent_crud | ✅ PASS | id=869, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=870, ingest=success, chars=2449, type=vendor_payment_terms_policy, deleted=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=354, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=E5BC4046-97B7-4979-8176-958C7B7DAE1A, http=200); post-approval file=True |
...
| Workflow engine | wf14:file_transfer_sftp_upload | ✅ PASS | status=completed; remote-file=True (xfer_20260802_162227.txt); content-ok=True |
