# Platform Regression Report — 20260902_204902 (INSTALLED 10.0.0.6)

- Build: `97f5794` | Base: `http://10.0.0.6:5001` | Baseline: `results_20260902_194220.json`
...
| Agents | agent_crud | ✅ PASS | id=7022, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=7023, ingest=success, chars=2450, type=vendor_payment_terms_policy, deleted=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=1073, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Agents | comp_agent_admits_unknown | ✅ PASS | admits-it-does-not-know=True; reply='I couldn’t retrieve information about the internal project code **REGP-20260902_204902-XQ7** because the lookup service has an **i' |
| Knowledge/Docs | comp_knowledge_retrievable_after_ingest | ✅ PASS | agent=7026, kid=8018, marker=ZEPHYR204902, retrieved-the-ingested-fact=True |
| Knowledge/Docs | comp_knowledge_deleted_not_retrievable | 🟡 XPASS | deleted kid=8018; deleted content STILL retrievable=False (must be False) |
...
| Data/NLQ | comp_nlq_admits_unanswerable | ✅ PASS | fabricated-London-foot-traffic=False; reply='<table border="1" class="dataframe">\n  <thead>\n    <tr style="text-align: right;">\n      <th></th>\n      <th>total_foot_traffic</t' |
...
| Data Explorer | de_pin_live | ❌ FAIL | message 'Pin Table →' -> {'widgets': 1, 'tables': 1, 'canvases': 0, 'images': 0, 'panelOpen': True, 'toast': '', 'title': 'Untitled Dashboard'} |
