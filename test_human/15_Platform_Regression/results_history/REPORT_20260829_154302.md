# Platform Regression Report — 20260829_154302 (local dev)

- Build: `504e6ec` | Base: `http://localhost:5001` | Baseline: `results_20260828_194957.json`

## Verdict: **CLEAN** — 49 PASS / 51 SKIP / 4 XFAIL
...
| Agents | agent_crud | ✅ PASS | id=999, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=1001, ingest=success, chars=2449, type=vendor_guide, deleted=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=557, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=F2F157C2-F815-4BF6-B10D-D5EFF03DBD19, http=200); post-approval file=True |
