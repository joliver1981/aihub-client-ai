# Platform Regression Report — 20260826_192816 (local dev)

- Build: `012fc96` | Base: `http://localhost:5001` | Baseline: `results_20260826_192102.json`

## Verdict: **FAILURES (no baseline regression)** — 1 FAIL / 67 PASS / 29 SKIP / 6 XFAIL / 1 XPASS
...
| Agents | agent_crud | ✅ PASS | id=935, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=937, ingest=success, chars=2449, type=vendor_payment_terms, deleted=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=505, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Agents | comp_agent_admits_unknown | ✅ PASS | admits-it-does-not-know=True; reply='## 🔎 Project Code Lookup\n\nI couldn’t find an internal or user-knowledge record for **`REGP-20260826_192816-XQ7`**.\n\n- **Project na' |
| Knowledge/Docs | comp_knowledge_retrievable_after_ingest | ✅ PASS | agent=941, kid=1788, marker=ZEPHYR192816, retrieved-the-ingested-fact=True |
| Knowledge/Docs | comp_knowledge_deleted_not_retrievable | 🟡 XPASS | deleted kid=1788; deleted content STILL retrievable=False (must be False) |
...
| Data/NLQ | comp_nlq_admits_unanswerable | ✅ PASS | fabricated-London-foot-traffic=False; reply="I'm sorry, I encountered an issue processing your request. Please try a different question or contact support if the problem persi" |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=ACA412BF-D3E7-46A7-8DF4-1DB2B8FEE488, http=200); post-approval file=True |
...
| Workflow engine | wf14:file_transfer_sftp_upload | ✅ PASS | status=completed; remote-file=True (xfer_20260826_193436.txt); content-ok=True |
