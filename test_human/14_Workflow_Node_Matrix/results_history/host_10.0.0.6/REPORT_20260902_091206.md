# Workflow Node Regression Report — 20260902_091206

- Build: `4fb6da8` | Base: `http://10.0.0.6:5001` | Tier <= 2 | Baseline: `results_20260829_154652.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260902_091206`

## Verdict: **FAILURES (no baseline regression)** — 1 FAIL / 1 PASS / 36 SKIP
...
| file_transfer_sftp_upload | 2 | ❌ FAIL | status=failed; remote-file=False (xfer_20260902_091206.txt); content-ok=False \| log-tail: Executing node: file write (File) ~ Workflow execution started: NODEREG-file_transfer_sftp_upload |
