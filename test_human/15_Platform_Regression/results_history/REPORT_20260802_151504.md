# Platform Regression Report — 20260802_151504 (local dev)

- Build: `0dcdc24` | Base: `http://localhost:5001` | Baseline: `results_20260802_130402.json`

## Verdict: **FAILURES (no baseline regression)** — 1 FAIL / 48 PASS / 29 SKIP / 4 XFAIL
...
| Agents | agent_crud | ✅ PASS | id=851, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=852, ingest=success, chars=2449, type=policy_document, deleted=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=313, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Connections | conn_execute_real_table | ❌ FAIL | invoices=-1 (want >=17, original oracle 17); body={"response": "{\n  \"status\": \"success\",\n  \"columns\": [\n    \"n\"\n  ],\n  \"rows\": [\n    [\n      \" |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=0CB9DD5F-E621-4245-944A-71A8483BBFB9, http=200); post-approval file=True |
...
| Workflow engine | wf14:file_transfer_sftp_upload | ✅ PASS | status=completed; remote-file=True (xfer_20260802_151657.txt); content-ok=True |
