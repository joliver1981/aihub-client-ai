# Workflow Node Regression Report — 20260803_193548

- Build: `52b3588` | Base: `http://localhost:5001` | Tier <= 3 | Baseline: `results_20260803_165418.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260803_193548`
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=632E0442-7969-42FB-9344-7EC84A1869E5, http=200); post-approval file=True |
...
| file_transfer_sftp_upload | 2 | ✅ PASS | status=completed; remote-file=True (xfer_20260803_193548.txt); content-ok=True |
...
| comp_excel_export_throughput | 3 | ⚠️ XFAIL | status=completed; 40 rows in 51.0s = 0.78 rows/sec (want >= 5.0); 1000 rows would take ~21.2 min \| log-tail: Executing node: big (Database) ~ Workflow execution started: NODEREG-comp_excel_export_throughput |
