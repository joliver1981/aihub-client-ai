...
AZURE_OPENAI_DEPLOYMENT_NAME = os.getenv('AZURE_OPENAI_DEPLOYMENT_NAME', 'gpt-5.6-terra')
...
AZURE_OPENAI_DEPLOYMENT_NAME_ALTERNATE_MINI = os.getenv('AZURE_OPENAI_DEPLOYMENT_NAME_ALTERNATE_MINI', 'gpt-5.6-luna')
...
AZURE_OPENAI_DEPLOYMENT_NAME_MINI = os.getenv('AZURE_OPENAI_DEPLOYMENT_NAME_MINI', 'gpt-5.6-luna')
...
OPENAI_DEPLOYMENT_NAME = os.getenv('OPENAI_MODEL', 'gpt-5.6-terra')
OPENAI_DEPLOYMENT_NAME_MINI = os.getenv('OPENAI_MODEL_MINI', 'gpt-5.6-luna')
...
DOC_AMBIGUITY_HINT_ENABLED = os.getenv('DOC_AMBIGUITY_HINT_ENABLED', 'True').lower() in ('true', '1', 'yes')  # Append AMBIGUITY NOTE when several same-type documents all match every entity the user named
DOC_AMBIGUITY_HINT_MAX_DOCS = int(os.getenv('DOC_AMBIGUITY_HINT_MAX_DOCS', '8'))  # Above this many matching documents it is breadth, not a shortlist of alternatives - stay silent
...
AUTOMATIONS_ENV_CRED_INJECTION = False                  # Legacy P0/P1 path: inject credential VALUES as AIHUB_CONN_*/AIHUB_SECRET_* env vars (default off — the aihub_runtime SDK resolves via run token instead)
