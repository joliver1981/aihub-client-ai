# Workflow Node Regression Report — 20260802_173619

- Build: `a1e5853` | Base: `http://localhost:5001` | Tier <= 3 | Baseline: `results_20260802_173302.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260802_173619`
...
|---|---|---|---|
| comp_excel_export_throughput | 3 | ⚠️ XFAIL | status=completed; 40 rows in 60.6s = 0.66 rows/sec (want >= 5.0); 1000 rows would take ~25.2 min \| log-tail: Executing node: big (Database) ~ Workflow execution started: NODEREG-comp_excel_export_throughput |
