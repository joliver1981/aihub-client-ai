# Workflow Node Regression Report — 20260730_163202

- Build: `e6227e4` | Base: `http://localhost:5001` | Tier <= 2 | Baseline: `none (first run)`
- Outputs: `C:\temp\aihub_test\nodereg\20260730_163202`
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=6FA26BDE-9835-4A91-9FF8-148DF7A57275, http=200); post-approval file=True |
...
| file_transfer_sftp_upload | 2 | ✅ PASS | status=completed; remote-file=True (xfer_20260730_163202.txt); content-ok=True |
