# Platform Regression Report — 20260731_074428

- Build: `5a3e564` | Base: `http://localhost:5001` | Baseline: `results_20260731_074024.json`

## Verdict: **CLEAN** — 39 PASS / 18 SKIP / 1 XFAIL
...
| Agents | agent_crud | ✅ PASS | id=841, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | ingest=success, chars=2449, type=policy_document, deleted=True |
| Connections | connection_crud_query | ✅ PASS | id=232, query-42=True, deleted=True (del http=200) |
...
| Approvals | approvals_api | ✅ PASS | http=200, pending=137 |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=3E43F3C8-E5FA-4DAB-8796-A250929AF987, http=200); post-approval file=True |
...
| Workflow engine | wf14:file_transfer_sftp_upload | ✅ PASS | status=completed; remote-file=True (xfer_20260731_074508.txt); content-ok=True |
