# Workflow Node Regression Report — 20260803_204814

- Build: `69e12b2` | Base: `http://localhost:5001` | Tier <= 3 | Baseline: `results_20260803_194949.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260803_204814`
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=AF4F286D-FCF8-4120-BAF5-1C56C3643037, http=200); post-approval file=True |
...
| file_transfer_sftp_upload | 2 | ✅ PASS | status=completed; remote-file=True (xfer_20260803_204814.txt); content-ok=True |
...
| comp_excel_export_throughput | 3 | ✅ PASS | status=completed; 40 rows in 6.5s = 6.14 rows/sec (want >= 5.0); 1000 rows would take ~2.7 min |
