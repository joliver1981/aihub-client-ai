# Platform Regression Report — 20260802_130402 (local dev)

- Build: `c0c0d46` | Base: `http://localhost:5001` | Baseline: `results_20260801_135021.json`

## Verdict: **REGRESSIONS DETECTED** — 1 FAIL / 48 PASS / 29 SKIP / 4 XFAIL

## 🔴 REGRESSIONS vs baseline

| check | was | now |
|---|---|---|
| conn_execute_real_table | PASS | **FAIL** |
...
| Agents | agent_crud | ✅ PASS | id=847, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=848, ingest=success, chars=2449, type=policy_document, deleted=True |
...
| Approvals | approvals_api | ✅ PASS | http=200, pending=229 |
...
| Connections | conn_create_and_list | ✅ PASS | id=303, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Connections | conn_execute_real_table | ❌ FAIL | expect 17 invoices; body={"response": "{\n  \"status\": \"success\",\n  \"columns\": [\n    \"n\"\n  ],\n  \"rows\": [\n    [\n      \"57\"\n    ]\n  ]\n}", "status" |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=6BFEBDE7-120C-4601-91AC-22A8996D4E8B, http=200); post-approval file=True |
...
| Workflow engine | wf14:file_transfer_sftp_upload | ✅ PASS | status=completed; remote-file=True (xfer_20260802_130609.txt); content-ok=True |
