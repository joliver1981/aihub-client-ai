...
[Files]
; =============================================================================
; ONEDIR: Each service is now a folder with exe + dependencies
...
; NEW: MCP Gateway, Builder Service, Builder Data
...
// =============================================================================
// FIXED v2.1: Proper service cleanup for NSSM-managed services
// Updated: Added MCP Gateway, Builder Service, Builder Data, Cloud Gateway (12 total)
//
...
var
  ResultCode: Integer;
  Services: array[0..11] of String;
  Executables: array[0..11] of String;
  NssmPath: String;
  I: Integer;
begin
  Services[0] := 'AIHub';
  ...
  Log('========================================');
  Log('STOPPING AND REMOVING SERVICES (v2.2)');
  Log('========================================');
...
begin
  ...
  // =========================================================================
  // NEW: Register MCP Gateway service
  // =========================================================================
  ShellExec('', ExpandConstant('{app}\nssm.exe'),
  ...
  // =========================================================================
  // NEW: Register Cloud Storage Gateway service
  // =========================================================================
  ShellExec('', ExpandConstant('{app}\nssm.exe'),
  ...
  // =========================================================================
  // NEW: Register Builder Data Service
  // =========================================================================
  ShellExec('', ExpandConstant('{app}\nssm.exe'),
...
; NEW: MCP Gateway, Cloud Gateway, Builder Service, Builder Data
