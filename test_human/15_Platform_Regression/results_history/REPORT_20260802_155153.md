# Platform Regression Report — 20260802_155153 (local dev)

- Build: `78310ab` | Base: `http://localhost:5001` | Baseline: `none (first run)`
...
| Agents | agent_crud | ✅ PASS | id=863, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=864, ingest=success, chars=2449, type=vendor_payment_terms_policy, deleted=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=334, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=892AE21A-AF39-411C-8756-306DAC5B05E3, http=200); post-approval file=True |
...
| Workflow engine | wf14:file_transfer_sftp_upload | ✅ PASS | status=completed; remote-file=True (xfer_20260802_155406.txt); content-ok=True |
