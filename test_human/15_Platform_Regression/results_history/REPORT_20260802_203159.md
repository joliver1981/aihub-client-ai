# Platform Regression Report — 20260802_203159 (local dev)

- Build: `db844c3` | Base: `http://localhost:5001` | Baseline: `results_20260802_201712.json`

## Verdict: **CLEAN** — 18 PASS / 2 XFAIL / 1 XPASS

## 🟢 Fixed vs baseline

- comp_pages_no_error_leakage: FAIL → PASS
- comp_automation_partial_output_caught: FAIL → PASS
...
| Knowledge/Docs | comp_knowledge_retrievable_after_ingest | ✅ PASS | agent=878, kid=1705, marker=ZEPHYR203159, retrieved-the-ingested-fact=True |
| Knowledge/Docs | comp_knowledge_deleted_not_retrievable | 🟡 XPASS | deleted kid=1705; deleted content STILL retrievable=False (must be False) |
...
| Data/NLQ | comp_nlq_admits_unanswerable | ✅ PASS | http=200, admits-no-data=True, fabricated-a-number=False |
