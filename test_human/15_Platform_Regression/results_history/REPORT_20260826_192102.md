# Platform Regression Report — 20260826_192102 (local dev)

- Build: `012fc96` | Base: `http://localhost:5001` | Baseline: `results_20260826_184824.json`

## Verdict: **FAILURES (no baseline regression)** — 1 FAIL / 49 PASS / 50 SKIP / 4 XFAIL
...
| Agents | agent_crud | ✅ PASS | id=930, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=932, ingest=success, chars=2449, type=vendor_payment_terms, deleted=True |
| Data/NLQ | nlq_data_chat | ❌ FAIL | http=200, contains-15=False, tail=sists.", "metadata": {}, "type": "text"}], "type": "rich_content"}, "rich_content_enabled": true, "special_message": ""} |
...
| Connections | conn_create_and_list | ✅ PASS | id=495, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=3FB0790F-3CFE-49F7-B845-D91D462273FF, http=200); post-approval file=True |
...
| Workflow engine | wf14:file_transfer_sftp_upload | ✅ PASS | status=completed; remote-file=True (xfer_20260826_192529.txt); content-ok=True |
