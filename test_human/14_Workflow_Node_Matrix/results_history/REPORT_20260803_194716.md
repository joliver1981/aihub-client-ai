# Workflow Node Regression Report — 20260803_194716

- Build: `52b3588` | Base: `http://localhost:5001` | Tier <= 3 | Baseline: `results_20260803_194650.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260803_194716`

## Verdict: **CLEAN** — 24 PASS / 11 SKIP / 2 XFAIL / 1 XPASS

## 🟡 ATTENTION — known bugs now PASSING (fix landed: update matrix / close task)

- **comp_excel_export_throughput**: was XPASS, now XPASS
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=0048782F-1380-4655-B222-6E027BBAFB28, http=200); post-approval file=True |
...
| file_transfer_sftp_upload | 2 | ✅ PASS | status=completed; remote-file=True (xfer_20260803_194716.txt); content-ok=True |
...
| comp_excel_export_throughput | 3 | 🟡 XPASS | status=completed; 40 rows in 4.9s = 8.15 rows/sec (want >= 5.0); 1000 rows would take ~2.0 min |
