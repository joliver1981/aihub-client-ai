# Workflow Node Regression Report — 20260802_173759

- Build: `a1e5853` | Base: `http://localhost:5001` | Tier <= 3 | Baseline: `results_20260802_173619.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260802_173759`
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=6921F287-37B0-48DE-A327-67286B2A99F1, http=200); post-approval file=True |
...
| file_transfer_sftp_upload | 2 | ✅ PASS | status=completed; remote-file=True (xfer_20260802_173759.txt); content-ok=True |
...
| comp_excel_export_throughput | 3 | ⚠️ XFAIL | status=completed; 40 rows in 60.4s = 0.66 rows/sec (want >= 5.0); 1000 rows would take ~25.2 min \| log-tail: Executing node: big (Database) ~ Workflow execution started: NODEREG-comp_excel_export_throughput |
