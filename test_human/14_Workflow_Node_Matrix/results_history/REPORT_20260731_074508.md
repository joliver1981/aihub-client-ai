# Workflow Node Regression Report — 20260731_074508

- Build: `5a3e564` | Base: `http://localhost:5001` | Tier <= 2 | Baseline: `results_20260731_074349.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260731_074508`
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=3E43F3C8-E5FA-4DAB-8796-A250929AF987, http=200); post-approval file=True |
...
| file_transfer_sftp_upload | 2 | ✅ PASS | status=completed; remote-file=True (xfer_20260731_074508.txt); content-ok=True |
...
## Config lint (informational) — scanned ALL 245 persisted workflows
