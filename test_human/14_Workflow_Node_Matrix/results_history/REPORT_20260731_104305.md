# Workflow Node Regression Report — 20260731_104305

- Build: `7524ebb` | Base: `http://10.0.0.6:5001` | Tier <= 2 | Baseline: `results_20260731_074508.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260731_104305`

## Verdict: **REGRESSIONS DETECTED** — 1 FAIL / 27 SKIP

## 🔴 REGRESSIONS vs baseline (was PASS, now broken)

| check | was | now |
|---|---|---|
| file_transfer_sftp_upload | PASS | **FAIL** |
...
| portal_node_run | 2 | ⏭ SKIP | env missing: ['portal'] |
| file_transfer_sftp_upload | 2 | ❌ FAIL | status=failed; remote-file=False (xfer_20260731_104305.txt); content-ok=False \| log-tail: Executing node: file write (File) ~ Workflow execution started: NODEREG-file_transfer_sftp_upload |
...
| Portal | ⏭ check exists, SKIPPED this run: portal_node_run |
| Human Approval | ⏭ check exists, SKIPPED this run: human_approval_approve, human_approval_reject |

## Config lint (informational) — scanned ALL 8 persisted workflows
