# Platform Regression Report — 20260731_074024

- Build: `5a3e564` | Base: `http://localhost:5001` | Baseline: `results_20260730_213444.json`
...
| Agents | agent_crud | ✅ PASS | id=840, listed=True, deleted=True |
...
| Connections | connection_crud_query | ✅ PASS | id=231, query-42=True, deleted=True (del http=200) |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=6BCD8D53-219E-443A-A014-FC60C9C9B8D8, http=200); post-approval file=True |
...
| Workflow engine | wf14:file_transfer_sftp_upload | ✅ PASS | status=completed; remote-file=True (xfer_20260731_074105.txt); content-ok=True |
