# Platform Regression Report — 20260902_205439 (INSTALLED 10.0.0.6)

- Build: `97f5794` | Base: `http://10.0.0.6:5001` | Baseline: `results_20260902_204923.json`

## Verdict: **FAILURES (no baseline regression)** — 2 FAIL / 52 PASS / 47 SKIP / 2 XFAIL / 3 XPASS
...
| Agents | agent_crud | ✅ PASS | id=7027, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=7028, ingest=success, chars=2450, type=policy_document, deleted=True |
| Data/NLQ | nlq_data_chat | ✅ PASS | http=200, contains-15=True, tail=g_mode": "hybrid", "source": "dataframe"}, "type": "rich_content"}, "rich_content_enabled": true, "special_message": ""} |
...
| Connections | conn_create_and_list | ✅ PASS | id=1093, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Agents | comp_agent_admits_unknown | ✅ PASS | admits-it-does-not-know=True; reply='I couldn’t retrieve information about the internal project code **REGP-20260902_205439-XQ7** because the request failed due to an ' |
| Knowledge/Docs | comp_knowledge_retrievable_after_ingest | ✅ PASS | agent=7031, kid=8021, marker=ZEPHYR205439, retrieved-the-ingested-fact=True |
| Knowledge/Docs | comp_knowledge_deleted_not_retrievable | 🟡 XPASS | deleted kid=8021; deleted content STILL retrievable=False (must be False) |
...
| Data/NLQ | comp_nlq_admits_unanswerable | ✅ PASS | fabricated-London-foot-traffic=False; reply='*I couldn’t find foot traffic results for a London store last week. Please confirm the exact store name or location, and try speci' |
| Data Explorer | de_pin_dashboard | ❌ FAIL | table toolbar Pin -> {'widgets': 2, 'tables': 2, 'canvases': 0, 'images': 0, 'panelOpen': False, 'toast': '', 'title': 'Untitled Dashboard'} |
| Data Explorer | de_pin_live | ❌ FAIL | table toolbar Pin -> {'widgets': 2, 'tables': 2, 'canvases': 0, 'images': 0, 'panelOpen': False, 'toast': '', 'title': 'Untitled Dashboard'} |
