# Workflow Node Regression Report — 20260903_183805

- Build: `907df6d` | Base: `http://localhost:5001` | Tier <= 2 | Baseline: `results_20260829_154652.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260903_183805`
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=21F8A48C-4762-47DA-82AA-850A69DE1A1D, http=200); post-approval file=True |
...
| file_transfer_sftp_upload | 2 | ⏭ SKIP | env missing: ['sftp'] — SFTP test rig not running (Start_SFTP_Server.bat) |
