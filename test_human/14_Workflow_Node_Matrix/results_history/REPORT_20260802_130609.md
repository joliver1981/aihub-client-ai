# Workflow Node Regression Report — 20260802_130609

- Build: `c0c0d46` | Base: `http://localhost:5001` | Tier <= 2 | Baseline: `results_20260801_135218.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260802_130609`
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=6BFEBDE7-120C-4601-91AC-22A8996D4E8B, http=200); post-approval file=True |
...
| file_transfer_sftp_upload | 2 | ✅ PASS | status=completed; remote-file=True (xfer_20260802_130609.txt); content-ok=True |
