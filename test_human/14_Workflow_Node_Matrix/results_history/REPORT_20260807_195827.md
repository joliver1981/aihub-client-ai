# Workflow Node Regression Report — 20260807_195827

- Build: `227c3e8` | Base: `http://localhost:5001` | Tier <= 2 | Baseline: `results_20260806_201924.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260807_195827`
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=6A6BC76A-6F44-4914-B2D6-D133EACF335F, http=200); post-approval file=True |
...
## Config lint (informational) — scanned ALL 265 persisted workflows
