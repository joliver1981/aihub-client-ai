# Workflow Node Regression Report — 20260828_195706

- Build: `a874bed` | Base: `http://localhost:5001` | Tier <= 2 | Baseline: `results_20260826_204847.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260828_195706`
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=F5B12C17-F855-49D7-BDF4-DEB797243D2F, http=200); post-approval file=True |
