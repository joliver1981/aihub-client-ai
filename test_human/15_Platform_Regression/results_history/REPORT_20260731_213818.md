# Platform Regression Report — 20260731_213818 (local dev)

- Build: `ab0ccd6` | Base: `http://localhost:5001` | Baseline: `results_20260731_213722.json`

## Verdict: **FAILURES (no baseline regression)** — 2 FAIL / 18 PASS

## 🟢 Fixed vs baseline

- conn_edit_preserves_password: FAIL → PASS

## Full matrix (by area)

| area | check | status | evidence |
|---|---|---|---|
| Connections | conn_create_and_list | ✅ PASS | id=243, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Connections | comp_conn_unicode | ❌ FAIL | returned={"response": "{\n  \"status\": \"success\",\n  \"columns\": [\n    \"u\"\n  ],\n  \"rows\": [\n    [\n      \"caf\\u00e9-\\u4e2d\\u6587-\\u00f1\"\n    ]\n  ]\n} |
...
| Connections | comp_conn_non_select_write | ❌ FAIL | http=200, write-refused=False (False = the endpoint EXECUTES writes), body={"response": "{\n  \"status\": \"success\",\n  \"columns\": \"\",\n  \"rows\": \"\"\n}", "status": "success"} |
