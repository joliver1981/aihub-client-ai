# AuthZ Matrix - 20260803_163127

- Tier: A+B | Baseline: `results_20260802_163741.json`
...
| a7_session_cookie_flags | PASS | HttpOnly=True, SameSite=False, hdr='session=.eJwljjFuAzEMBP-i2gUpUiTlzxxEkUICAwlwZ1eG_x4BKWeL2XmXY515fZX783zlrRzfUe6lUtcIsBGhO' |
...
| b2_no_horizontal_agent_access | PASS | A reading B's agent 894 -> http=404, leaked=False |
| b3_anonymous_write_actually_persists | XFAIL | anon POST http=201, id=354, visible to an authenticated reader=True |
| b4_unauth_sensitive_reads | XFAIL | /get/users=401/122b/leak=False; /get/connections=401/122b/leak=False; /get/agents=302/241b/leak=False; /api/scheduler/jobs=200/32317b/leak=True; /api/workflow/approvals=200/307393b/leak=True; LEAKING=2 |
...
| `/api/workflow/analytics` | 200 24450b |
| `/api/workflow/approvals` | 200 307393b |
