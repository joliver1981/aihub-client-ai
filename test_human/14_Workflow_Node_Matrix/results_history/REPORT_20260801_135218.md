# Workflow Node Regression Report — 20260801_135218

- Build: `32191fc` | Base: `http://localhost:5001` | Tier <= 2 | Baseline: `results_20260731_180231.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260801_135218`

## Verdict: **CLEAN** — 16 PASS / 11 SKIP / 1 XFAIL

## 🟢 Fixed vs baseline

- file_transfer_sftp_upload: FAIL → PASS
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=8BF57054-5241-4582-B445-BA4AB7F2F0C5, http=200); post-approval file=True |
...
| file_transfer_sftp_upload | 2 | ✅ PASS | status=completed; remote-file=True (xfer_20260801_135218.txt); content-ok=True |
