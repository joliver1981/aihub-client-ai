# Platform Regression Report — 20260819_184234 (local dev)

- Build: `27c0c99` | Base: `http://localhost:5001` | Baseline: `results_20260807_195620.json`

## Verdict: **REGRESSIONS DETECTED** — 1 ERROR / 47 PASS / 51 SKIP / 4 XFAIL

## 🔴 REGRESSIONS vs baseline

| check | was | now |
|---|---|---|
| automation_lifecycle | PASS | **ERROR** |
...
| Agents | agent_crud | ✅ PASS | id=910, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=911, ingest=success, chars=2449, type=policy_document, deleted=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=485, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=1B81EBC1-0301-4404-88FB-3457908BEF29, http=200); post-approval file=True |
