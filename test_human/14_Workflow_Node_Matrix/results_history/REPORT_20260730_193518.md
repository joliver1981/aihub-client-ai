# Workflow Node Regression Report — 20260730_193518

- Build: `1e74416` | Base: `http://localhost:5001` | Tier <= 2 | Baseline: `results_20260730_193412.json`
- Outputs: `C:\temp\aihub_test\nodereg\20260730_193518`

## Verdict: **CLEAN** — 14 PASS / 11 SKIP / 1 XFAIL
...
| human_approval_approve | 2 | ✅ PASS | status=completed; decided=True (req=45DE1A47-8913-4631-BA24-ED5590B8779A, http=200); post-approval file=True |
...
| file_transfer_sftp_upload | 2 | ✅ PASS | status=completed; remote-file=True (xfer_20260730_193518.txt); content-ok=True |
...
## Config lint (informational) — scanned ALL 241 persisted workflows
