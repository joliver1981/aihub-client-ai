# Platform Regression Report — 20260802_151926 (local dev)

- Build: `0dcdc24` | Base: `http://localhost:5001` | Baseline: `results_20260802_151504.json`

## Verdict: **CLEAN** — 49 PASS / 29 SKIP / 4 XFAIL

## 🟢 Fixed vs baseline

- conn_execute_real_table: FAIL → PASS
...
| Agents | agent_crud | ✅ PASS | id=855, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=856, ingest=success, chars=2449, type=vendor_payment_terms_policy, deleted=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=324, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=2A808A1B-4F6B-45C2-A5B6-8BE321974A0D, http=200); post-approval file=True |
...
| Workflow engine | wf14:file_transfer_sftp_upload | ✅ PASS | status=completed; remote-file=True (xfer_20260802_152111.txt); content-ok=True |
