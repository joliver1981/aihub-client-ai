# Platform Regression Report — 20260802_203318 (local dev)

- Build: `db844c3` | Base: `http://localhost:5001` | Baseline: `results_20260802_203159.json`

## Verdict: **REGRESSIONS DETECTED** — 1 FAIL / 66 PASS / 29 SKIP / 6 XFAIL / 1 XPASS

## 🔴 REGRESSIONS vs baseline

| check | was | now |
|---|---|---|
| comp_nlq_admits_unanswerable | PASS | **FAIL** |
...
| Agents | agent_crud | ✅ PASS | id=879, listed=True, deleted=True |
...
| Knowledge/Docs | knowledge_ingest_delete | ✅ PASS | agent=880, ingest=success, chars=2449, type=vendor_payment_terms_policy, deleted=True |
...
| Connections | conn_create_and_list | ✅ PASS | id=394, server=10.0.0.6, db=ERPDB, user=ai_user |
...
| Knowledge/Docs | comp_knowledge_retrievable_after_ingest | ✅ PASS | agent=883, kid=1708, marker=ZEPHYR203318, retrieved-the-ingested-fact=True |
| Knowledge/Docs | comp_knowledge_deleted_not_retrievable | 🟡 XPASS | deleted kid=1708; deleted content STILL retrievable=False (must be False) |
...
| Data/NLQ | comp_nlq_admits_unanswerable | ❌ FAIL | http=200, admits-no-data=False, fabricated-a-number=True |
...
| Workflow engine | wf14:human_approval_approve | ✅ PASS | status=completed; decided=True (req=8D907A98-E4BF-4C69-8670-42E8624FB454, http=200); post-approval file=True |
...
| Workflow engine | wf14:file_transfer_sftp_upload | ✅ PASS | status=completed; remote-file=True (xfer_20260802_203559.txt); content-ok=True |
