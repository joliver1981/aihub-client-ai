...
| a7_session_cookie_flags | PASS | HttpOnly=True, SameSite=False, hdr='session=.eJwljjFuAzEMBP-iOoVIiRTpzxxIiYSNAAlwZ1dB_m4FKXe2mPkpR55x3cvteb7ioxyPVW6lYWTn5jyRI' |
...
| a11_anonymous_get_sweep_ratchet | PASS | probed=236, ANONYMOUSLY REACHABLE=6 vs pinned 29 (ratchet: must not grow - PASS is NOT 'no problem'), errors=2, cleaned-up-minted-rows=0; first: /, /api/setup/status, /api_check, /index, /landing, /login |
