...
[Files]
; =============================================================================
; ONEDIR: Each service is a folder with exe + dependencies (12 services total)
...
; MCP Gateway, Builder Service, Builder Data, Cloud Gateway
...
// Updated: 12 services total (core 8 + MCP Gateway, Cloud Gateway,
//          Builder Service, Builder Data)
//
...
begin
  ...
  Log('========================================');
  Log('STOPPING AND REMOVING SERVICES (v2.1)');
  Log('========================================');
...
begin
  ...
  Log('All 12 services installed and started successfully');
...
; MCP Gateway, Cloud Gateway, Builder Service, Builder Data
