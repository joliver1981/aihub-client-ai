# AuthZ Matrix - 20260802_155625

- Tier: A+B | Baseline: `none`
...
|---|---|---|
| a1_global_auth_middleware_wired | XFAIL | middleware-module-present=True, init_auth_middleware called by=NOBODY, anon GET /api/scheduler/jobs -> 200 31635b (reachable=True) |
...
| a7_session_cookie_flags | PASS | HttpOnly=True, SameSite=False, hdr='session=.eJwljktqBDEMBe_idRaSZeszl2kkSyYhkED3zCrk7mnIqni1eNRPO_ZZ13t7PM9XvbXjI9ujdTLJBPVME' |
...
| b2_no_horizontal_agent_access | PASS | A reading B's agent 867 -> http=404, leaked=False |
| b3_anonymous_write_actually_persists | XFAIL | anon POST http=201, id=316, visible to an authenticated reader=True |
| b4_unauth_sensitive_reads | XFAIL | /get/users=401/122b/leak=False; /get/connections=401/122b/leak=False; /get/agents=302/241b/leak=False; /api/scheduler/jobs=200/31635b/leak=True; /api/workflow/approvals=200/307739b/leak=True; LEAKING=2 |
...
| `/api/workflow/analytics` | 200 22755b |
| `/api/workflow/approvals` | 200 307739b |
| `/api/workflow/assistant/history` | 200 142b |
| `/api/workflow/builder/training-stats` | 200 129b |
| `/api/workflow/logs` | 200 16115b |
